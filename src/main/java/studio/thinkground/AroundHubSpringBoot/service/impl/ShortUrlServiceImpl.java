...
import studio.thinkground.AroundHubSpringBoot.data.dto.NaverUriDto;
...
import studio.thinkground.AroundHubSpringBoot.service.ShortUrlService;
...
public class ShortUrlServiceImpl implements ShortUrlService {
    ...
    private final ShortUrlRepository shortUrlRedisRepository;

    @Autowired
    public ShortUrlServiceImpl(ShortUrlDAO shortUrlDAO, ShortUrlRepository shortUrlRedisRepository) {
...
//    }
    ...
    public ShortUrlResponseDto deleteByOriginalUrl(String url) {
