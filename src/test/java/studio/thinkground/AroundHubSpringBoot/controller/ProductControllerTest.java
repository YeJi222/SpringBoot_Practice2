...
// static -> 코드길이를 줄이기 위해 사용된 방법 메소드들을 간략히 사용하기 위해)
...
public class ProductControllerTest {
    ...
    // http://localhost:9090/api/v1/product-api/product/{productId}
    @Test
    ...
    void createProductTest() throws Exception {
        ...
        Gson gson = new Gson();
        String content = gson.toJson(productDto); // productDto를 json 형태로 변경한 string 값
